		...
		<?		
			...
			else
			{
				if ( (isset ($_SESSION['prof'])) && (isset($_SESSION['id_cliente'])) )  
				{
					...
					<form action="DeleteTopic2.php" method="post" name="ftp" id="form_ftp" >
					<tr><td class = 'modo1' colspan=2 align="center" > Delete Topic </td></tr>
					<tr><th > Enter the name of the topic you want to delete:</td><td align="left" class = 'modo1'><input name ="name" type="text"  size="25" maxlength="20" value =""></td></tr>
					<tr><td class="modo1"></td><td class="modo1" align="center" ><input name="Submit" type="submit" value="Delete Topic" /><INPUT type="Reset"></td></tr>
					</table>
